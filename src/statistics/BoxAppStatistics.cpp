...
BoxAppStatistics::BoxAppStatistics()
{
    type_ = StatisticsType::BoxAppType;
}

void BoxAppStatistics::updateCount(const StatisticsKey key)
{
...
QVariantMap BoxAppStatistics::serialization(const std::unordered_map<StatisticsKey, int32_t> &tempMap)
{
    QVariantMap mapData;
