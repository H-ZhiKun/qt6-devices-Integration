...
ImpurityStatistics::ImpurityStatistics()
{
    type_ = StatisticsType::BoxAppType;
}

void ImpurityStatistics::updateCount(const StatisticsKey key)
{
...
QVariantMap ImpurityStatistics::serialization(const std::unordered_map<StatisticsKey, int32_t> &tempMap)
{
    QVariantMap mapData;
