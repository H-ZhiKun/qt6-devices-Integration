...
ExtraTest::ExtraTest(QObject *parent) : QObject(parent)
{
}

TestLogistics ExtraTest::testLogistics(uint32_t number, const std::string &code)
{
...
void ExtraTest::setPrintTest(bool flag)
{
    printTest_ = flag;
}

bool ExtraTest::isPrintTest() const
{
    return printTest_;
}

bool ExtraTest::isTestRemove() const
{
    return removeType_ != TestRemoveType::normalRemove;
}

bool ExtraTest::getPosRemoveNeeded()
{
    switch (removeType_)
    {
    case TestRemoveType::normalRemove: {
        break;
    }
    case TestRemoveType::noRemove: {
        return false;
    }
    case TestRemoveType::allRemove: {
        return true;
    }
    case TestRemoveType::gapRemove: {
        lastPosRemove_ = !lastPosRemove_;
        return lastPosRemove_;
    }
    default:
        break;
    }
...
void ExtraTest::setTestRemove(TestRemoveType type)
{
    removeType_ = type;
}