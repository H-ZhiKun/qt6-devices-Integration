    ...
    */
    class BGAPI2_DECL iterator {
     public:
        ...
        * \return    _pairs The result is a pair structure with a 'first' and a 'second' value. The 'first' value is
        *            the string ID of the object. The 'second' value is the pointer to the BGAPI2 object.
        */
        _pairs* operator->();
    ...
    */
    class BGAPI2_DECL iterator {
     public:
        ...
        * \fn        operator->()
        * \brief     Member access operator. This operator dereferences the list pointer.
        * \return    _pairi The result is a pair structure with a 'first' and a 'second' value. The 'first' value is
        *            the string ID of the object. The 'second' value is the pointer to the BGAPI2 object.
        */
        _pairi* operator->();
    ...
    */
    class BGAPI2_DECL iterator {
     public:
        ...
        * \fn        operator->()
        * \brief     Member access operator. This operator dereferences the list pointer.
        * \return    _paird The result is a pair structure with a 'first' and a 'second' value. The 'first' value is
        *            the string ID of the object. The 'second' value is the pointer to the BGAPI2 object.
        */
        _paird* operator->();
    ...
    */
    class BGAPI2_DECL iterator {
     public:
        ...
        * \fn        operator->()
        * \brief     Member access operator. This operator dereferences the list pointer.
        * \return    _pairds The result is a pair structure with a 'first' and a 'second' value. The 'first' value is
        *            the string ID of the object. The 'second' value is the pointer to the BGAPI2 object.
        */
        _pairds* operator->();
    ...
    */
    class BGAPI2_DECL iterator {
     public:
        ...
        * \fn        operator->()
        * \brief     Member access operator. This operator dereferences the list pointer.
        * \return    _pairb The result is a pair structure with a 'first' and a 'second' value. The 'first' value is
        *            the string ID of the object. The 'second' value is the pointer to the BGAPI2 object.
        */
        _pairb* operator->();
...
class BGAPI2_DECL Node {
 public:
    ...
    *            types are defined in header file bgapi2_def.h. See definitions BGAPI2_NODEINTERFACE_xxx.
    ...
    *            The available access modes are defined in header file bgapi2_def.h.
    ...
    *            Node::GetImposedAccessMode(). The available access modes are defined in header file bgapi2_def.h.
    *            See definitions BGAPI2_NODEACCESS_xxx.
    ...
    *            defined in the header file bgapi2_def.h. See the definitions BGAPI2_NODEREPRESENTATION_xxx.
    ...
    */
    class BGAPI2_DECL iterator {
     public:
        ...
        * \fn        operator->()
        * \brief     Member access operator. This operator dereferences the list pointer.
        * \return    _pairnm The result is a pair structure with a 'first' and a 'second' value. The 'first' value is
        *            the string ID of the object. The 'second' value is the pointer to the BGAPI2 object.
        */
        _pairnm* operator->();
...
class BGAPI2_DECL INode {
 public:
    ...
    *            the detour across a NodeMap object.
    * 
...
class BGAPI2_DECL Buffer : public INode, public Events::EventControl {
 public:
    ...
    *
    *            See the payload type definitions in bgapi2_def.h (BGAPI2_PAYLOADTYPE_xxx).
...
class BGAPI2_DECL Device : public INode, public Events::DeviceEventControl {
 public:
    ...
    * \exception Exceptions::ObjectInvalidException The calling object is not valid.
    * \exception BGAPI2::InvalidParameterException matrix missing.
    * \exception BGAPI2::NotImplementedException color matrix not supported.
    * \exception BGAPI2::ErrorException Error while reading color matrix.
    */
...
class BGAPI2_DECL Image : public INode {
 public:
    ...
    */
    ...
    /**
    * \fn        Init(BGAPI2::Buffer* buffer);
    * \brief     This function reinitialize an Image object.
    * \param     buffer The Buffer object.
    * \exception Exceptions::ErrorException Function returns with error.
    */
    void Init(BGAPI2::Buffer* buffer);
...
class BGAPI2_DECL ImageProcessor : public INode {
 public:
    ...
    * \param     matrix A 3x3 matrix.
    * \exception BGAPI2::InvalidParameterException Matrix missing.
    * \exception BGAPI2::ErrorException Error while writing color matrix.
    */
    void SetColorMatrix(const double matrix[3][3]);
...
class BGAPI2_DECL Polarizer {
 public:
    ...
    *                via the Polarizer::Enable() method.
    * \param[in]     format The format to enable or disable
...
* \see     BGAPI2::Events::DataStreamEventControl::CancelGetFilledBuffer
* \see     BGAPI2::Events::DataStreamEventControl::GetFilledBuffer
*/
