...
GroupBox {
    ...
    function initValve() {
        ...
        if (item0 === null) {
            ...
            item0.itemName = "阀1";
            item0.handMoveAddr = "XY001_di_0069";
        }
        if (item1 === null) {
            console.log("阀2 no item");
        } else {
            item1.itemName = "阀2";
            item1.handMoveAddr = "XY002_di_0071";
        }
        if (item2 === null) {
            console.log("阀3 no item");
        } else {
            item2.itemName = "阀3";
            item2.handMoveAddr = "XY003_di_0073";
        }
        if (item3 === null) {
            console.log("阀4 no item");
        } else {
            item3.itemName = "阀4";
            item3.handMoveAddr = "XY004_di_0075";
        }
        if (item4 === null) {
            console.log("阀5 no item");
        } else {
            item4.itemName = "阀5";
            item4.handMoveAddr = "XY005_di_0077";
        }
        if (item5 === null) {
            console.log("阀6 no item");
        } else {
            item5.itemName = "阀6";
            item5.handMoveAddr = "XY006_di_0079";
        }
    }
    Connections {
